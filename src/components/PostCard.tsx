...
export default function PostCard({
  ...
  const dueDate = 'due_date' in post ? format(new Date(post.due_date), 'MMM dd, yyyy') : null;
  const postType = 'post_type' in post ? post.post_type : ('suggested_type' in post ? post.suggested_type : 'Unknown');
